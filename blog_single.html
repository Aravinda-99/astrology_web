...
">
                                ...
                                <li>
                                    <a href="javascript:;">
                                        ...
                                        <span class="__cf_email__" data-cfemail="7a090f0a0a15080e3a0d1f1809130e1f54191517">[email&#160;protected]</span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="as_menu_wrapper">
                                ...
                                <div class="as_menu">
                                    <ul>
                                        ...
                                        <li><a href="javascript:;" class="active"> blog</a>
                                            <ul class="as_submenu">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        <div class="as_blog_box">
                            <div class="as_blog_img">
                                <a href="blog_detail.html"><img src="assets/images/blog_single1.jpg" alt="" class="img-responsive"></a>
                            ...
                            <div class="as_blog_detail">
                                <ul>
                                    ...
                                    <li><a href="javascript:;"><img src="assets/images/svg/comment1.svg" alt="">0 comments</a></li>
                                    <li><a href="javascript:;"><img src="assets/images/svg/view1.svg" alt="">0 views</a></li>
                                </ul>
                                <h4 class="as_subheading"> Rahu Enters Cancer and Ketu Enters Capricorn.</h4> 
                                <p class="as_font14 as_margin0 as_padderBottom10">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy that walks through our doors.</p>
                                <p class="as_font14 as_padderBottom20">Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.</p>
                                ...
                                <p class="as_padderTop30 as_padderBottom20">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy that walks through our doors.</p>
 
                                <div class="as_bloquote text-center">
                                    <p>“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.” </p>
                                    <h3 class="as_margin0 as_padderTop10">David Lee <span>- Businessman</span></h3>
                                </div>
                                ...
                                <div class="as_tag_wrapper as_padderBottom50">
                                    <ul>
                                        ...
                                        <li><a href="javascript:;" class="as_btn">Gemstone</a></li>
                                        <li><a href="javascript:;" class="as_btn">Face Reading</a></li>
                                        <li><a href="javascript:;" class="as_btn">Planet</a></li>
                                        <li><a href="javascript:;" class="as_btn">Tarot Cards</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="as_about_admin">
                                ...
                                <div class="as_aboutDetail">
                                    <h3 class="as_subheading">John Simth <span>/ About Admin</span> </h3>
                                    ...
                                    <div class="as_footer_widget">
                                        ...
                                        <ul class="as_contact_list">
                                            ...
                                            <li>
                                                ...
                                                <p>
                                                    <a href="javascript:;"><span class="__cf_email__" data-cfemail="e0819394928f8c8f8799a08598818d908c85ce838f8d">[email&#160;protected]</span></a>
                                                </p> 
                                            </li> 
                                        </ul>
                                    </div>
    ...
    <!-- javascript -->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery.js" type="878d7553287f8cd4cde94c38-text/javascript"></script>
    <script src="assets/js/bootstrap.js" type="878d7553287f8cd4cde94c38-text/javascript"></script>
    <script type="878d7553287f8cd4cde94c38-text/javascript" src="assets/js/plugin/slick/slick.min.js"></script>
    <script type="878d7553287f8cd4cde94c38-text/javascript" src="assets/js/plugin/select2/select2.min.js"></script>
    <script type="878d7553287f8cd4cde94c38-text/javascript" src="assets/js/plugin/countto/jquery.countTo.js"></script>
    <script type="878d7553287f8cd4cde94c38-text/javascript" src="assets/js/plugin/airdatepicker/datepicker.min.js"></script>
    <script type="878d7553287f8cd4cde94c38-text/javascript" src="assets/js/plugin/airdatepicker/i18n/datepicker.en.js"></script>
    <script src="assets/js/custom.js" type="878d7553287f8cd4cde94c38-text/javascript"></script>  
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="878d7553287f8cd4cde94c38-|49" defer=""></script></body>
</html>