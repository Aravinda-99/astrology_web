...
<body>
    ...
    <div class="as_main_wrapper as_shopsingle_page">
...
">
                                ...
                                <li>
                                    <a href="javascript:;">
                                        ...
                                        <span class="__cf_email__" data-cfemail="60131510100f121420170502130914054e030f0d">[email&#160;protected]</span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
...
<li><a href="service_single.html">service single</a></li>
                                        ...
                                        <li><a href="javascript:;" class="active">shop</a>
                                            <ul class="as_submenu">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="as_shopsingle_slider">
                            ...
                            <div class="as_shopsingle_for">
                                ...
                                <div class="as_prod_img">
                                    <img src="assets/images/p3.jpg" alt="" class="img-responsive">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="as_product_description">
                            <h3 class="as_subheading as_margin0 as_padderBottom10">Blue Treasure Diamond</h3>
                            <h2 class="as_price">$200 <del>$300</del> <span class="as_off as_btn">32% Off</span></h2> 
                            <div class="product_rating as_padderBottom10">
                                <span class="rating_star">
                                    <img src="assets/images/rating.png" alt="">
                                    <span>(20 customer review)</span>
                                </span>
                                <span class="ref_number as_font14">Product Id: 212589</span> 
                            </div>
                            ...
                            <div class="prod_detail">
                                <div class="prod_quantity as_padderBottom40">
                                    Quantity :
                                    <div class="quantity">
                                        <button type="button" class="qty_button minus"><img src="assets/images/svg/arrow_down.svg" alt=""></button>
                        ...
                        <div class="as_tab_wrapper as_padderTop80">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                  ...
                                  <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="Tabinfo" data-bs-toggle="tab" data-bs-target="#tabinfo" type="button" role="tab" aria-controls="tabinfo" aria-selected="false">Additional Information</button>
                                  </li>
                                  <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content as_padderTop60" id="myTabContent">
                                <div class="tab-pane fade show active" id="today" role="tabpanel" aria-labelledby="Today"> 
                                   <p class="as_font14 as_padderBottom20">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                                   <p class="as_font14 as_padderBottom20">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                </div>
                                <div id="adinfo tabinfo" class="tab-pane fade" role="tabpanel" aria-labelledby="Tabinfo">
                                    <p class="as_font14 as_padderBottom20">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                                   <p class="as_font14 as_padderBottom20">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="as_product_box">
                                <div class="as_product_img">
                                    <img src="assets/images/prod2.jpg" alt="" class="img-responsive">
                                    <span class="as_new_tag">new</span>

                                    <ul>
                                        <li><a href="#"><img class="as_cart_svg" src="assets/images/svg/cart.svg" alt=""><span>Add To Card</span></a></li>
                                        <li><a href="#"><img src="assets/images/svg/view.svg" alt=""></a></li>
                                        <li><a href="#"><img src="assets/images/svg/wishlist.svg" alt=""></a></li>
                                        <li><a href="#"><img src="assets/images/svg/compare.svg" alt=""></a></li>
                                    </ul>
                                </div> 
                                <div class="as_product_detail">
                                    <span><img src="assets/images/rating.png" alt=""></span>
                                    <h4 class="as_subheading">Gold Crown Treasure</h4>
                                    <span class="as_price">$20.00 <del>$80.00</del> <span class="as_orange"></span></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div class="as_footer_widget">
                                        ...
                                        <ul class="as_contact_list">
                                            ...
                                            <li>
                                                ...
                                                <p>
                                                    <a href="javascript:;"><span class="__cf_email__" data-cfemail="11706265637e7d7e7668517469707c617d743f727e7c">[email&#160;protected]</span></a>
                                                </p> 
                                            </li> 
                                        </ul>
                                    </div>
    ...
    <!-- javascript -->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery.js" type="937f51e1e186d8378565facf-text/javascript"></script>
    <script src="assets/js/bootstrap.js" type="937f51e1e186d8378565facf-text/javascript"></script>
    <script type="937f51e1e186d8378565facf-text/javascript" src="assets/js/plugin/slick/slick.min.js"></script>
    <script type="937f51e1e186d8378565facf-text/javascript" src="assets/js/plugin/select2/select2.min.js"></script>
    <script type="937f51e1e186d8378565facf-text/javascript" src="assets/js/plugin/countto/jquery.countTo.js"></script>
    <script type="937f51e1e186d8378565facf-text/javascript" src="assets/js/plugin/airdatepicker/datepicker.min.js"></script>
    <script type="937f51e1e186d8378565facf-text/javascript" src="assets/js/plugin/airdatepicker/i18n/datepicker.en.js"></script>
    <script src="assets/js/custom.js" type="937f51e1e186d8378565facf-text/javascript"></script>  
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="937f51e1e186d8378565facf-|49" defer=""></script></body>
</html>