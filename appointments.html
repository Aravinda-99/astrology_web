...
">
                                ...
                                <li>
                                    <a href="javascript:;">
                                        ...
                                        <span class="__cf_email__" data-cfemail="463533363629343206312324352f32236825292b">[email&#160;protected]</span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
...
<li><a href="service_single.html">service single</a></li>
       ...
       <section class="as_appointment_wrapper as_padderBottom40 as_padderTop50">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h1 class="as_heading as_heading_center">Make an Appointment</h1>
                        ...
                        <form class="as_appointment_form">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <button class="as_btn">Book Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="as_footer_widget">
                                    ...
                                    <ul class="as_contact_list">
                                        ...
                                        <li>
                                            ...
                                            <p>
                                                <a href="javascript:;"><span class="__cf_email__" data-cfemail="d2b3a1a6a0bdbebdb5ab92b7aab3bfa2beb7fcb1bdbf">[email&#160;protected]</span></a>
                                            </p> 
                                        </li> 
                                    </ul>
                                </div>
    ...
    <!-- javascript -->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery.js" type="51c7b99913acbc5d023773dc-text/javascript"></script>
    <script src="assets/js/bootstrap.js" type="51c7b99913acbc5d023773dc-text/javascript"></script>
    <script type="51c7b99913acbc5d023773dc-text/javascript" src="assets/js/plugin/slick/slick.min.js"></script>
    <script type="51c7b99913acbc5d023773dc-text/javascript" src="assets/js/plugin/select2/select2.min.js"></script>
    <script type="51c7b99913acbc5d023773dc-text/javascript" src="assets/js/plugin/countto/jquery.countTo.js"></script>
    <script type="51c7b99913acbc5d023773dc-text/javascript" src="assets/js/plugin/airdatepicker/datepicker.min.js"></script>
    <script type="51c7b99913acbc5d023773dc-text/javascript" src="assets/js/plugin/airdatepicker/i18n/datepicker.en.js"></script>
    <script src="assets/js/custom.js" type="51c7b99913acbc5d023773dc-text/javascript"></script>  
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="51c7b99913acbc5d023773dc-|49" defer=""></script></body>
</html>